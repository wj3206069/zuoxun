<template>
  <div class="holiday-detail">
    <div class="company-zi-zhi__head">
      <h4 class="company-zi-zhi__head--text">请假详情</h4>
            ...
            <div class="time-foot">
              <div class="duration-bag">
                <div style="display: flex; width:100%; align-item: center;">
                  ...
                  <!-- <i class="zxicon zx-dengdai"
                    style="color: #BFBFBF; font-size: 20px;"></i>
                  <i class="zxicon zx-butongguo"
                    style="color: #F03F16; font-size: 20px;"></i> -->
                  <div class="handle same-layout"
                    style="margin-left: 5px;">查丽 • 已转批</div>
                </div>
              </div>
              <div class="idea same-layout"
                style="border-bottom: 1px dashed #A9B3BA; padding-bottom: 10px;">
              ...
              <div class="duration-bag">
                <div style="display: flex; align-item: center;">
                  ...
                  <i class="zxicon zx-butongguo"
                    style="color: #F03F16; font-size: 20px;"></i> -->
                  <div class="handle same-layout"
                    style="margin-left: 5px;">邹纪根 • 已同意</div>
                </div>
              </div>
              <div class="idea same-layout"
                style="padding-bottom: 10px;">
                <p style="margin-left: 5px;">同意</p>
              </div>
