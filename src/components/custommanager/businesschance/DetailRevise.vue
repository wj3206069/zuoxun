<template>
    <div class="zi-zhi-shenqing">
    	<div class="header_title">
    		<a class="return_btn" @click="$router.back(-1)"><i class="zxicon zx-jt-left"></i>返回</a><span class="header_name">商机详情</span>
    	</div>
    	<div style="max-height: calc(100vh - 100px);" class="body_box">
	        <el-form ref="zizhiform" :model="formData" :rules="rules" label-width="220px" style="width: 680px;padding-top:15px;height: calc(100vh - 200px);">
	            <el-form-item label="商机标题" prop="chance_title" >
	                <el-input v-model="formData.chance_title" :disabled="is_revise" placeholder="请输入商机标题"></el-input>
	            </el-form-item>
                <el-form-item label="商机内容" prop="chance_content" >
	                <el-input v-model="formData.chance_content" :disabled="is_revise" placeholder="请输入商机内容"></el-input>
	            </el-form-item>
                <el-form-item label="所属客户" prop="chance_custom" >
	                <el-select v-model="formData.chance_custom" :disabled="is_revise" placeholder="请输入所属客户">
                ...
                <el-form-item label="客户联系人" prop="chance_contact" >
	                <el-input v-model="formData.chance_contact" :disabled="is_revise" placeholder="请输入客户联系人"></el-input>
	            </el-form-item>              
                <el-form-item label="商机来源" prop="chance_from">
	                <el-select v-model="formData.chance_from" :disabled="is_revise" placeholder="请选择商机来源">
                ...
                <el-form-item label="商机类型" prop="chance_type">
	                <el-select v-model="formData.chance_type" :disabled="is_revise" placeholder="请选择商机类型">
                ...
                <el-form-item label="商机阶段" prop="chance_stage">
	                <el-select v-model="formData.chance_stage" :disabled="is_revise" placeholder="请选择商机阶段">
                ...
                <el-form-item label="预算规模" prop="chance_budget" >
	                <el-input v-model="formData.chance_budget" :disabled="is_revise" placeholder="请输入预算规模"></el-input>
	            </el-form-item> 
                <el-form-item label="接单时间" prop="chance_time">
	                <el-date-picker v-model="formData.chance_time" :disabled="is_revise" type="date" value-format="yyyy-MM-dd"></el-date-picker>
	            </el-form-item>
