<template>
    <div class="zi-zhi-shenqing">
    	<div class="header_title">
    		<a class="return_btn" @click="$router.back(-1)"><i class="zxicon zx-jt-left"></i>返回</a><span class="header_name">添加拜访</span>
    	</div>
    	<div style="max-height: calc(100vh - 100px);" class="body_box">
	        <el-form ref="zizhiform" :model="formData" :rules="rules" label-width="220px" style="width: 680px;padding-top:15px;height: calc(100vh - 200px);">
	            <el-form-item label="拜访标题" prop="visit_title" >
	                <el-input v-model="formData.visit_title" placeholder="请输入拜访标题"></el-input>
	            </el-form-item>
                <el-form-item label="拜访内容" prop="visit_content" >
	                <el-input v-model="formData.visit_content" placeholder="请输入拜访内容"></el-input>
	            </el-form-item>
                <el-form-item label="拜访客户" prop="visit_custom" >
	                <!-- <el-input v-model="formData.visit_custom" placeholder="请输入拜访客户"></el-input> -->
                ...
                <el-form-item label="拜访联系人" prop="visit_contact" >
	                <!-- <el-input v-model="formData.visit_contact" placeholder="请输入拜访联系人"></el-input> -->
                ...
                <el-form-item label="拜访时间" prop="visit_time">
	                <el-date-picker v-model="formData.visit_time" type="date" value-format="yyyy-MM-dd"></el-date-picker>
	            </el-form-item>              
	            <el-form-item>
