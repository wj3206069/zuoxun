    	...
    	<div style="max-height: calc(100vh - 100px);" class="body_box">
	        <el-form ref="zizhiform" :model="formData" :rules="rules" label-width="220px" style="width: 680px;padding-top:15px">
	             <el-form-item label="所属单位" prop="groupId">
	                <el-select v-model="formData.groupId" placeholder="请选择所属单位"  @change="getGroupNamebyId" >
                       <el-option v-for=" (item,index ) in userGroupList " :key="index" :label="item.deptname" :value="item.id"></el-option>
                    </el-select>
	            </el-form-item>
                ...
                <el-form-item label="项目性质" prop="property">
	                <el-select v-model="formData.property" placeholder="请选择项目性质" >
                 ...
                 <el-form-item label="项目类型" prop="region">
	                <el-select v-model="formData.region" placeholder="请选择项目类型" >
	            ...
	            <el-form-item>
                    <el-button type="primary" @click="handleSubmit" style="background-color:#2179d6;border:0;">提交</el-button>
                </el-form-item>
	        </el-form>
...
<script>
    ...
    import {getRelatedCompany,getProjectGroup,saveNewProject} from '@/assets/utils/api';
    ...
    export default {
        ...
        methods: {
            ...
            loadUserGroup(){
                ...
                getRelatedCompany(query).then(res=>{
                    console.log(res)
            ...
            //加载联系人数据
            getContacts(){
            this.$axios.get('/proxyapi/pm/getContacts?contactname=' + this.contactname+"&groupid="+this.formData.customManagerId).then(res => {
            ...
            getDefaultMemberList(userTree, resList, ids){
                ...
                this.$refs['zizhiform'].validate(valid => {
                        if (valid) {
                            ...
                            tempList=JSON.parse(JSON.stringify(this.showMemberList));
                            let tempList2 = [];
                            tempList2=JSON.parse(JSON.stringify(this.showReportList));
