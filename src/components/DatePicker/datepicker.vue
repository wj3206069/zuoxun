<template>
  <div class="date-picker">
      ...
      <div class="el-picker-panel__body-wrapper">
        <slot name="sidebar"
              class="el-picker-panel__sidebar"></slot>
...
export default {
  ...
  methods: {
    ...
    emit(value, ...args) {
      if (!value) {
        ...
        const dates = value.map(
          date => (this.showTime ? clearMilliseconds(date) : clearTime(date))
        )
    ...
    prevMonth() {
      ...
      this.$emit('prevClick', this.date)
    },
    nextMonth() {
      this.date = nextMonth(this.date)
      this.cellStatus = null
      this.$emit('nextClick', this.date)
    },
    prevYear() {
