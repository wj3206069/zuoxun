<template>
    <div class="zi-zhi-shenqing">
    	<div class="header_title">
    		<a class="return_btn" @click="$router.back(-1)"><i class="zxicon zx-jt-left"></i>返回</a><span class="header_name">增加资质</span>
    	</div>
    	<div style="max-height: calc(100vh - 200px);" class="body_box">
	        <el-form ref="zizhiform" :model="formData" :rules="rules" label-width="220px" style="width: 680px;padding-top:15px;">
                ...
                <el-form-item label="证书编号" prop="certificate_id" >
	                <el-input v-model="formData.certificate_id" placeholder="请输入证书编号"></el-input>
	            </el-form-item>
                <el-form-item label="颁发单位" prop="certificate_company">
                    <div class="website-content">
                        <el-tag :key="tag" v-for="tag in formData.certificate_company" closable :disable-transitions="false" @close="handleClose(tag)">
                            {{tag}}
                        </el-tag>
                        <el-input
                            class="input-new-tag"
                        ...
                        <el-button v-else class="button-new-tag" size="small" @click="showInput">+ 增加单位</el-button>
                    </div>                
	            </el-form-item>
                <el-form-item label="颁发有效期" prop="certificate_starttime" >
	                <!-- <el-input v-model="formData.custom_name" placeholder=""></el-input> -->
                    <el-date-picker style="display:inline-block;width:219px;" v-model="formData.certificate_starttime" type="date" value-format="yyyy-MM-dd" placeholder="请输入颁发日"></el-date-picker>
                    至
                    <el-date-picker style="display:inline-block;width:219px;" v-model="formData.certificate_endtime" type="date" value-format="yyyy-MM-dd" placeholder="请输入到期日"></el-date-picker>
                ...
                <el-form-item label="办理费用" prop="certificate_spend" >
	                <el-input style="width:400px;" v-model="formData.certificate_spend" placeholder="请填写金额"></el-input>
                    <span style="padding:0 10px;">元</span>
	            </el-form-item>
                <el-form-item label="第三方机构" prop="certificate_thired" >
	                <el-input v-model="formData.certificate_thired" placeholder="请输入机构名称"></el-input>
	            </el-form-item>
                ...
                <el-form-item label="年审频率" prop="certificate_CheckOnce">
	                <el-select v-model="formData.certificate_CheckOnce" placeholder="请选择年审频率">
                        <el-option v-model="formData.certificate_CheckOnce" label="每年年审" value="每年年审"></el-option>
                        <el-option v-model="formData.certificate_CheckOnce" label="每五年审" value="每五年审"></el-option>
                        <el-option v-model="formData.certificate_CheckOnce" label="每十年审" value="每十年审"></el-option>
                    </el-select>
	            </el-form-item>
