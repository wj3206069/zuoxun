<template>
  <div class="statistics">
    <div class="company-zi-zhi__head">
      <h4 class="company-zi-zhi__head--text">资产入库</h4>
    </div>
    ...
    <div class="zi-zhi-records">
      <div class="zi-zhi__table-box">
        <el-table :data="vacation_data" border class="table_css1" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="所属公司" prop="device_Company" align="center"></el-table-column>
          <el-table-column label="固定资产编号" prop="device_bh" align="center"></el-table-column>
          <el-table-column label="固定资产名称" prop="device_mingcheng" align="center"></el-table-column>
          <el-table-column label="固定资产类型" prop="device_Type" align="center"></el-table-column>
          <el-table-column label="品牌" prop="device_pp" align="center"></el-table-column>
          <el-table-column label="型号" prop="device_xh" align="center"></el-table-column>
          <el-table-column label="购入时间" prop="device_Time" align="center"></el-table-column>
