<template>
  <div class="zi-zhi-shenqing">
    <div class="header_title">
      <a class="return_btn" @click="$router.back(-1)"><i class="zxicon zx-jt-left"></i>返回</a><span class="header_name">新建报废单</span>
    </div>
    <div style="max-height: calc(100vh - 100px);" class="body_box">
      <el-form ref="zizhiform" :model="formData" :rules="rules" label-width="160px" style="width: 100%;padding-top:15px;height: calc(100vh - 200px);">
        <div style="display:flex">
          ...
          <el-form-item label="操作人" prop="chance_content">
            <el-input v-model="formData.device_bfr" :disabled="!is_revise" placeholder="请输入操作人"></el-input>
          </el-form-item>
        ...
        <div style="display:flex">
          ...
          <el-form-item label="报废时间" prop="chance_time">
            <el-date-picker style="width:88%" placeholder="请输入报废时间" v-model="formData.device_Time" :disabled="is_revise" type="date" value-format="yyyy-MM-dd"></el-date-picker>
          </el-form-item>
        </div>
         <el-form-item label="报废类别" style="width: 49.5%;" prop="chance_content">
            <el-select v-model="formData.device_Company" :disabled="is_revise" placeholder="请选择报废类别">
              <el-option label="淘汰" value="淘汰"></el-option>
              <el-option label="报废" value="报废"></el-option>
            </el-select>
          </el-form-item>
        <!-- <div style="display:flex"> -->
        <el-form-item label="报废原因" prop="device_tip">
          <el-input type="textarea" style="width: 43.8%;" :autosize="{ minRows: 4}" v-model="formData.device_tip" :disabled="is_revise" placeholder="请输入报废详细情况"></el-input>
        </el-form-item>
        <!-- </div> -->
