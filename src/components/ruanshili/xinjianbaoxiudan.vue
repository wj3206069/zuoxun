<template>
  <div class="zi-zhi-shenqing">
    <div class="header_title">
      <a class="return_btn" @click="$router.back(-1)"><i class="zxicon zx-jt-left"></i>返回</a><span class="header_name">新建报修单</span>
    </div>
    <div style="max-height: calc(100vh - 100px);" class="body_box">
      <el-form ref="zizhiform" :model="formData" :rules="rules" label-width="160px" style="width: 100%;padding-top:15px;height: calc(100vh - 200px);">
        <div style="display:flex">
          <el-form-item label="报修单位" prop="device_Company">
            <el-select v-model="formData.device_bumen" :disabled="is_revise" placeholder="请选择报修部门">
          ...
          <!-- <el-form-item label="报修人" prop="chance_content">
            <el-input v-model="formData.device_bxr" :disabled="!is_revise" placeholder="请输入报修人"></el-input>
          </el-form-item> -->
        </div>
        <!-- <div style="display:flex">
          <el-form-item label="维修状态" prop="chance_content">
            <el-select v-model="formData.device_mingcheng" :disabled="is_revise" placeholder="请选择维修状态">
              <el-option label="待维修" value="深圳市政府"></el-option>
              <el-option label="正在维修" value="广州科技局"></el-option>
              <el-option label="已维修" value="广州科技局"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="维修花费" prop="chance_content">
            <el-input v-model="formData.device_xh" :disabled="is_revise" placeholder="请输入维修花费"></el-input>
          </el-form-item>
        </div> -->
        <div style="display:flex">
          ...
          <el-form-item label="报修时间" prop="chance_time">
          ...
          <el-form-item label="维修申请人" prop="chance_type" label-width="147px">
            <el-input style="width:203px;" :disabled="is_revise" placeholder="请输入维修申请人" v-model="formData.device_Money"> </el-input>
          </el-form-item>
        </div>
        <div style="display:flex">

          <!-- <el-form-item label="维修内容" prop="chance_custom">
            <el-input v-model="formData.device_pp" :disabled="is_revise" placeholder="请输入维修内容"></el-input>
          </el-form-item> -->
        </div>
        <el-form-item style="width:25%" label="报修原因" prop="chance_content">
            <el-select v-model="formData.device_reason" :disabled="is_revise" placeholder="请选择报修部门">
              <el-option label="蓝屏" value="蓝屏"></el-option>
              <el-option label="开不了机" value="开不了机"></el-option>
              <el-option label="有异响" value="有异响"></el-option>
            </el-select>
        </el-form-item>

        <!-- <div style="display:flex"> -->
        <el-form-item label="维修内容" prop="device_tip">
          <el-input type="textarea" style="width: 43.8%;" :autosize="{ minRows: 4}" v-model="formData.device_tip" :disabled="is_revise" placeholder="请输入维修详细情况"></el-input>
        </el-form-item>
        <!-- </div> -->
        ...
        <div style="padding-left:80px;">
            ...
            <el-dialog title="固定资产列表" :visible.sync="centerDialogVisible" width="80%" center>
...
export default {
  ...
  methods: {
    ...
    // getchange(checkList){
    //   var searchArr = checkList
    //   this.getDataType(searchArr)
    // },
    // getDataType(searchArr){
    //   var dataArr = []
    //     this.tableData3.forEach((ele,idx)=>{
    //     dataArr.push(ele.zxType)
    //   })  
    //   var newDataTable = []
    //   console.log("searchArr",searchArr)
    //   searchArr.forEach((ele,idx)=>{
    //     dataArr.forEach((e,i)=>{
    //          if(ele==dataArr[i]){
    //         console.log("eleeeeee",ele,i)
    //         console.log("searchArr",this.tableData3[i])
    //         newDataTable.push(this.tableData3[i])
    //         console.log("this.tableData3[i]",newDataTable)
    //       }
    //     })
    //   })
    //   this.tableData3 = []
    //   this.tableData3 =  newDataTable
    ...
    haveSelect () {
     ...
     handleSubmit () {
      ...
      this.$router.push({ name: 'shebeiweixiu', params: this.formData })
    },
  },
  created () {
    // console.log("this.$route.params.list", this.$route.params)
