<template>
  <div class="zi-zhi-shenqing" style=" min-width: 1500px;">
    <div class="header_title">
      ...
      <span class="header_name">清单详情</span>
    </div>
    <div style="max-height: calc(100vh - 100px);" class="body_box">
      <el-form ref="zizhiform" :model="formData" :rules="rules" label-width="160px" style="width: 100%;padding-top:15px;height: calc(100vh - 200px);">
        <div style="display:flex">
          ...
          <el-form-item label="资产类型" prop="device_Company">
            <el-select v-model="formData.device_Company" :disabled="is_revise" placeholder="请选择固定资产所属单位">
        ...
        <div style="display:flex">
          ...
          <el-form-item label="资产名称" prop="chance_custom" style="margin-left:17px;">
        ...
        <div style="display:flex">
          ...
          <el-form-item label="型号" prop="chance_content" style="  margin-left: 16px;">
        ...
        <div style="display:flex">
          <el-form-item label="维保类型" prop="chance_content">
            <el-select v-model="formData.device_mingcheng" :disabled="is_revise" placeholder="请选择使用年限">
              <el-option label="原厂保修" value="深圳市政府"></el-option>
              <el-option label="分厂保修" value="广州科技局"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="维保截止日期" style="width:25.8%;margin-left:8px;" prop="chance_time">
            <el-date-picker style="width:201px" placeholder="请输入入库日期" v-model="formData.device_Time" :disabled="is_revise" type="date" value-format="yyyy-MM-dd"></el-date-picker>
          </el-form-item>
        </div>
        <div style="display:flex">
          <el-form-item label="维保联系人员" prop="chance_content">
            <el-input v-model="formData.device_xh" :disabled="is_revise" placeholder="请输入购买金额"></el-input>
          </el-form-item>
          <el-form-item label="维保联系电话" prop="chance_content"  style="margin-left:23px;">
            <el-input v-model="formData.device_xh" :disabled="is_revise" placeholder="请输入购买金额"></el-input>
          </el-form-item>
        </div>
        <div style="display:flex">

          <el-form-item label="已使用年限" prop="chance_content">
            <el-select v-model="formData.device_mingcheng" :disabled="is_revise" placeholder="请选择使用年限">
              <el-option label="一年" value="深圳市政府"></el-option>
              <el-option label="两年" value="广州科技局"></el-option>
              <el-option label="三年" value="广州科技局"></el-option>
          ...
          <el-form-item label="剩余年限" prop="chance_content" style="padding-left:8px;">
            <el-select v-model="formData.device_mingcheng" :disabled="is_revise" placeholder="请选择使用年限">
              <el-option label="一年" value="深圳市政府"></el-option>
              <el-option label="两年" value="广州科技局"></el-option>
              <el-option label="三年" value="广州科技局"></el-option>
        ...
        <div style="display:flex">
          <el-form-item label="已折旧金额" prop="chance_content">
            <el-input v-model="formData.device_xh" :disabled="is_revise" placeholder="请输入购买金额"></el-input>
          </el-form-item>
          <el-form-item label="剩余金额" style="margin-left:22px;" prop="chance_content">
            <el-input v-model="formData.device_xh" :disabled="is_revise" placeholder="请输入购买金额"></el-input>
          </el-form-item>
        </div>
        <div style="display:flex">
        ...
        <el-form-item label="采购合同">
          <el-upload :disabled="is_revise" class="upload-demo" drag action="https://jsonplaceholder.typicode.com/posts/" multiple>
            ...
            <div class="el-upload__text">将文件拖到此处，或<em>点击上传</em></div>
               ...
               <el-form-item label="残值" prop="chance_content" style="margin-left:22px">
            <el-input v-model="formData.device_xh" :disabled="is_revise" placeholder="请输入购买金额"></el-input>
          </el-form-item>
        </div>
        ...
        <el-form-item>
          ...
          <el-button v-show="is_revise" type="primary" style="background-color:#409EFF;border:0;">修改</el-button>
