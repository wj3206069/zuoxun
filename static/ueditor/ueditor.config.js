...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //此处必须使用代理
        , serverUrl: "/proxyapiUeditor/core/exec"

        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的重新定义
        //去掉多图：, 'insertimage', 'help', 'gmap', 'insertframe', 'webapp', 'snapscreen', 'attachment'
        , toolbars: [[
            ...
            'simpleupload', 'emotion', 'scrawl', 'insertvideo', 'music', 'map', 'insertcode', 'pagebreak', 'template', 'background', '|',
